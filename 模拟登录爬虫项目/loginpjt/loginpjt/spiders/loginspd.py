...
#     #设置头信息变量，供下面的代码模拟成浏览器爬取
#     header = {
#         "User-Agent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.122 Safari/537.36 SE 2.X MetaSr 1.0"
#     }
#     def start_requests(self):
#         #首先爬一次登陆页，然后进入回调函数parse()
#         return [Request("http://accounts.douban.com/login",meta={'cookiejar':1},callback=parse())]
#
...
#         if len(captcha) > 0:
#             localpath = "C:/Users/Administrator/Desktop/captcha/11.png"
#             # 将服务器中的验证码图片存储到本地，供我们在本地直接进行查看
#             urllib.request.urlretrieve(captcha[0],filename=localpath)
#             print('请查看本地图片并且输入对应的验证码')
#             captcha_value = input()
#             data = {
#                 "for_email":"xd102401@163.com",
#                 "for_passwd":"xxd102401",
...
#         print('网页标题是：'+ title[0])
#         for i in range(0,len(notecontent)):
...
class LoginspdSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # 否则说明captcha列表中没有元素，即此时不需要输入验证码信息
            ...
            data = {
                "form_email": "xd102401@163.com",
                "form_password": "xxd102401",
                "redir": "https://www.douban.com/people/175384577/",
            }
        print("登录中…")
        # 通过FormRequest.from_response()进行登录
